...
const FEATURES: Feature[] = [
  ...
  },
  {
    icon: "🧭",
    title: "טראבי לייב",
    intro: "המסך החי של הטיול - מתעדכן לפי השעה, מזג האוויר והמיקום שלכם, ועונה על \"מה עושים עכשיו\".",
    points: [
      "מזג אוויר חי ושעה מקומית, ומה הנקודה הנוכחית והבאה במסלול של היום.",
      "יורד גשם או חם מדי? טראבי לייב מציע חלופות מקורות קרובות ומחליף בלחיצה.",
      "התעכבתם? \"התעכבנו\" מזיז את כל הנקודות הבאות, ו\"בדקו מה פתוח\" בודק שעות פתיחה חיות.",
      "שאלו את טראבי בשפה חופשית (\"אני רעב\", \"משהו עם ילדים\") וקבלו המלצה שמתאימה לרגע הזה.",
      "ספירה לאחור חיה לטיסה לפני הטיול.",
  ...
  },
  {
    ...
    points: [
      "הוספת טיסה כאן היא מה שמפעיל את הספירה לאחור במסך \"טראבי לייב\".",
...
function HowNowWorksDiagram() {
  return (
    <div className="overflow-hidden rounded-3xl border shadow-sm" style={{ borderColor: "rgba(124,58,237,0.15)" }}>
      <div className="px-5 pt-5">
        <h3 className="text-lg font-bold">🧭 איך "טראבי לייב" עובד</h3>
      </div>

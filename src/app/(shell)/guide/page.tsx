...
function HowMapWorksDiagram() {
  return (
    <div className="overflow-hidden rounded-3xl border shadow-sm" style={{ borderColor: "rgba(124,58,237,0.15)" }}>
      ...
      <div className="relative m-5 h-72 overflow-hidden rounded-2xl" style={{ background: "#e9efe4" }}>
        ...
        {[
          ...
          { top: "40%", right: "45%", color: "#F97316" },
          { top: "28%", right: "22%", color: "#1E3A5F" },
          { top: "62%", right: "55%", color: "#16A34A" },
          { top: "70%", right: "30%", color: "#F97316" },
        ].map((p, i) => (
          <span
            key={i}
        ...
        {/* callout 1 — pin */}
        <div className="absolute z-10 flex items-center gap-2" style={{ top: "18%", right: "8%" }}>

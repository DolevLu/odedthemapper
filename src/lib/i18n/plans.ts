...
const PLAN_TEXT: Record<"trial" | PlanKey, Record<Lang, PlanText>> = {
  ...
  family: {
    ...
    en: {
      name: "Travelers, Families & Nomads",
      audience: "For travelers, families and digital nomads",
      tagline: "Up to 5 destinations, rich ready-made maps, shared planning and Travi Live while you travel.",
      features: [
        "A clean experience - no ads 🚫📢",
        "Access to up to 5 destinations of your choice, each independently swappable once every 14 days",
        "Travi Live - what's happening now: time, weather, your next stop and one-tap re-planning",
        "Big, rich ready-made maps, or build a map from scratch - with AI and Google list import",
        "Shared planning for up to 5 users: editing, voting and real-time notifications",
        "An interactive digital album and collages",
        "Offline mode",
        "A bookable attractions list and discount codes",
        "Daily itinerary + PDF, expense tracking, phrasebook and packing checklist",
        "Priority support",
